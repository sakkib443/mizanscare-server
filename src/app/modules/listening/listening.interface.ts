...
export const LISTENING_BAND_CONVERSION: Record<number, number> = {
    ...
    31: 7.0, 30: 7.0,
    // Listening bands are NOT the same as Academic Reading at the 6/6.5 boundary: Listening is
    // 26-29 = 6.5 and 23-25 = 6.0, whereas Reading is 27-29 = 6.5 and 23-26 = 6.0. The Reading
    // boundary had been copied in here, so 26 correct answers scored 6.0 — half a band short.
