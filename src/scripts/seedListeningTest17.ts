...
<tr><td style='padding:8px'>Contact number:</td><td style='padding:8px'>8141 9680 (home)<br/><strong>[5]</strong> (mobile)</td></tr>
    ...
    { sectionNumber: 3, title: "Part 3", context: "A student discussing a paper with a professor.", instructions: "Questions 21\u201330", audioUrl: "", questions: [
      ...
      { blockType: "instruction" as const, content: "<strong>Questions 24\u201326</strong><br/>Choose the correct letter.<br/><strong>A</strong> if professor says REMAIN<br/><strong>B</strong> if professor says REWRITE<br/><strong>C</strong> if professor says REMOVE<br/>What suggestions does professor make?" },
